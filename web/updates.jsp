			...
			<div id="menu-adbox">
				<div class="details">
                 ...
                 <%
                    ...
                    out.println("kbkjcb"+session.getAttribute("uid"));
                    ...
                    try {
                        ...
                        String query = "UPDATE  product set ProductId='"+productId+"',productname='"+productname+"',SupName='"+SupName+"',UnitPrice='"+UnitPrice+"',CategoryId='"+CategoryId+"' WHERE ProductId='"+productId+"'";
                  
                        int n = stmt.executeUpdate(query);
                        if (n!=0){
                            out.println("<h4>updated Succefully!! <a href='home.html'></a></h4>");
                        }else{
